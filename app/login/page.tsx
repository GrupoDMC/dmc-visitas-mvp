  ...
  return (
    <main className="flex min-h-dvh items-center justify-center px-4 py-10">
      <div className="w-full max-w-sm">
        <div className="mb-6">
          <h1 className="font-heading text-xl font-semibold text-texto">Visitas técnicas</h1>
        ...
        <div className="rounded-card border border-borde bg-superficie p-5 shadow-tarjeta">
